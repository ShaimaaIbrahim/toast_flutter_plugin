...
class _MyAppState extends State<MyApp> {
  ...
  final _flutterToastPlugin = FlutterToastPlugin();
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      await _flutterToastPlugin.showToast("Hello Guys!!");
      platformVersion = await _flutterToastPlugin.getPlatformVersion() ?? 'Unknown platform version';
